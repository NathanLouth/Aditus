...
- Add option to keep program running once starting RDP or Shadow Session - 1.0.3 
- Add option to use computer name for domain when adding credentials to make bulk adding easier - 1.0.2
